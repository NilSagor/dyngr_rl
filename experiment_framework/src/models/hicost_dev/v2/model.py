...
from src.models.hicost_dev.v2.co_gnn import CoGNN
from src.models.hicost_dev.v2.time_delta_attention import TimeDeltaAttentionWalkEncoder
from src.models.hicost_dev.v2.multi_swalk import MultiScaleWalkSampler
...
class HiCoSTdev2(L.LightningModule):
    def __init__(self, config: HiCoSTConfig):
        ...
        # ── Proposed Causal Time Delta Attention ──
        # Walk setup
        if self.enable_walk:
